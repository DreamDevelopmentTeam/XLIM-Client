...
try:
    ...
    def ASKThread():
        ...
        while True:
            ...
            if opt.lower() == "ipbl-add":
                ...
                print(f"\033[38m[#] Admin => IP BlackList Add: {arg} \033[0m")
            if opt.lower() == "ipbl-del":
                if arg in IPBlackList:
                    IPBlackList.remove(arg)
                print(f"\033[38m[#] Admin => IP BlackList Remove: {arg} \033[0m")
            if opt.lower() == "ipbl-list":
                ...
                print(f"\033[38m[#] Admin => IP BlackList List \033[0m")
            if opt.lower() == "eval":
    ...
    def SSKThread():
        global RAD
        while True:
            tmpdata = input("\033[38mInput>\033[38m ")
            if tmpdata == "": continue
            if tmpdata == "#FC":
                ssk.sendto(
                    core.distToJsonBytes(
